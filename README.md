...
| Data | Tipo | Módulo/Pasta | Alteração | Impacto |
| ---- | ---- | ------------ | --------- | ------- |
| 2026-09-03 | Atualizado | `docs/cursor/templates/deploy-swarm.yml`, rule `132-*`, Skill Swarm | Step de validação Swarm: confirma Swarm ativo + manager e cria `app_network` overlay se ausente. | Deploy falha cedo se o runner não for manager; rede externa criada automaticamente. |
